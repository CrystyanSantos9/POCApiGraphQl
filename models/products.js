const init = connection => {
    ...
    const findImages = async(results) => {
        //para nao dar erro 1064 - ER_PARSE_ERROR
        //de nao encontrra imagens da relação dentro dos dados retornados
        if(results.length === 0){
            return []
        }
        const conn = await connection
    ...
    const findAllById = async(id) => {
        ...
        return  productWithImages[0] // trazer somente os dados do produto em específico, e naõ o array []
    }
